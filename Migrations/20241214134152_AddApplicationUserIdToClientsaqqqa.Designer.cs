...
namespace SportissimoProject.Migrations
{
    ...
    [Migration("20241214134152_AddApplicationUserIdToClientsaqqqa")]
    partial class AddApplicationUserIdToClientsaqqqa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportissimoProject.Models.Client", b =>
                {
                    ...
                    b.HasOne("SportissimoProject.Models.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("SportissimoProject.Models.Client", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
