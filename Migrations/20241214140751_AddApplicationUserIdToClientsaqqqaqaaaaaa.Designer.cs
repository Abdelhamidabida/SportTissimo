...
namespace SportissimoProject.Migrations
{
    ...
    [Migration("20241214140751_AddApplicationUserIdToClientsaqqqaqaaaaaa")]
    partial class AddApplicationUserIdToClientsaqqqaqaaaaaa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Client", b =>
                {
                    ...
                    b.HasOne("SportissimoProject.Models.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("Client", "ApplicationUserId")
